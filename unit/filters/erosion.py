                ...
                for y in range(self.len_y):
                    if img[x][y]:
                        ...
                        for xx in range(self.minsize):
                            if move_x_minus and x - xx >= 0 and img[x - xx][y]:
                                cnt_x += 1
                            else:
                                move_x_minus = False

                            if move_x_plus and x + xx < self.len_x and img[x + xx][y]:
                                cnt_x += 1
                            else:
                                move_x_plus = False
                        ...
                        for yy in range(self.minsize):
                            if move_y_minus and y - yy >= 0 and img[x][y - yy]:
                                cnt_y += 1
                            else:
                                move_y_minus = False

                            if move_y_plus and y + yy < self.len_y and img[x][y + yy]:
                                cnt_y += 1
                            else:
                                move_y_plus = False
